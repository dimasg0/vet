...
?>
        ...
        <div class="button-add-menu">
            ...
            <!-- <div class="col-2">
             <form action="http://vet/php/deleteowner.php" method="post">
               <button type="submit" id="regis-btn"> Видалити </button>
             </form>
            </div>

            <div class="col-3">
             <form style="padding: 10px;" action="http://vet/html/changeowner.php" method="post">
               <button type="submit" id="regis-btn"> Змінити </button>
             </form>
            </div> -->
        </div>
    </section>
